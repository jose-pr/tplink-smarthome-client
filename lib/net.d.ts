...
export interface IpSocket {
    ...
    open(): Promise<void>;
    close(): Promise<void>;
    read(input: Buffer, fill?: (msg: Buffer, offset: number) => undefined | Buffer): Promise<Buffer>;
}
export declare class TcpSocket implements IpSocket {
    ...
    close(): Promise<void>;
    read(buffer: Buffer, fill?: (msg: Buffer, offset: number) => Buffer | undefined): Promise<Buffer>;
}
export declare class UdpSocket implements IpSocket {
    ...
    open(): Promise<void>;
    close(): Promise<void>;
    read(send: Buffer, fill?: (msg: Buffer, offset: number) => Buffer | undefined): Promise<Buffer>;
}
